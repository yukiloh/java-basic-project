package Reflection.ReflectExerciseCase;
...
public class ReflectExercise {
    public static void main(String[] args) throws Exception{
        //1.加载配置文件
        InputStream propStream = ReflectExercise.class.getClassLoader().getResourceAsStream("Reflection/ReflectExerciseCase/Ref.properties");
