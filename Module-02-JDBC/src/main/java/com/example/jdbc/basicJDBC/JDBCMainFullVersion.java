...
public class JDBCMainFullVersion {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            List<SqlData> list = getAll(result);     //遍历打印
    ...
    //这是个进行封装的，查询数据库结果的方法    返回封装后的List<SqlData>，输入处理数据后获得的result
    public static List<SqlData> getAll(ResultSet result) throws SQLException {
        SqlData sqlData;  //提高作用域
